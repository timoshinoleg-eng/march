...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Даём гарантию 12 месяцев на все разработанное ПО. Первый месяц после запуска — бесплатная доработка: корректируем сценарии под реальные запросы клиентов, улучшаем распознавание, добавляем ответы на вопросы, которые появились после старта.",
  },
];
